...
if ($num > 0) {
    ...
    echo    "<th style='width:10em;'>Quantity</th>";
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo    "<td>";                     
        echo        "<form method='get' action='update_cart.php'>";
        echo            "<div class='input-group'>";
        echo                "<input type='number' name='new_quantity' value='{$quantity}' class='form-control'>";
        echo                "<input type='hidden' name='product_id' value={$id}>";
        echo                "<span class='input-group-btn'>";
        echo                    "<button class='btn btn-default update-quantity' name='action' value='update_quantity' role='submit'>";
        echo                        "Update";
        echo                    "</button>";
        echo                "</span>";       
        echo            "</div>";
